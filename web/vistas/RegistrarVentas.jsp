                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group d-flex ">
                                    <div class="col-sm-6 d-flex ">
                                        ...
                                        <button type="submit" name="accion" value="BuscarCliente" class="btn btn-outline-light-info">Buscar</button>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group d-flex ">
                                    <div class="col-sm-6 d-flex ">
                                        ...
                                        <button type="submit" name="accion" value="BuscarProducto" class="btn btn-outline-light-info">Buscar</button>
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach var="list" items="${lista}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="#"class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">Editar</a>
                                        <a href="#" class="btn btn-danger btnEliminar" data-bs-toggle="modal" data-bs-target="#exampleModal">Eliminar</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
